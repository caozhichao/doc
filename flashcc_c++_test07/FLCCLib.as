...
public class FLCCLib {
}

public class Heap {
	public var swigCPtr:int;
	public static function create():Heap {
		var obj = new Heap();
		obj.swigCPtr = _wrap_new_Heap();
		return obj;
	}

	public function destroy():void {
		_wrap_delete_Heap(swigCPtr);
	}

	public function reset():void {
		_wrap_Heap_reset(swigCPtr);
	}

	public function enqueue(value:int):void {
		_wrap_Heap_enqueue(swigCPtr, value);
	}

	public function modify(obj:int, newObj:int):Boolean {
		return _wrap_Heap_modify(swigCPtr, obj, newObj);
	}

	public function dequeue():int {
		return _wrap_Heap_dequeue(swigCPtr);
	}

	public function toString():void {
		_wrap_Heap_toString(swigCPtr);
	}
